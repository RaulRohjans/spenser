...
<template>
        <UCard class="shadow-xl">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('Total spent') }}</p>
        ...
        <UCard class="shadow-xl">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('Net cashflow') }}</p>
        ...
        <UCard class="shadow-xl">
            <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('Top category') }}</p>
        ...
        <UCard class="shadow-xl">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('Avg transaction value') }}</p>
