...
<template>
    <UCard
        class="drag-me shadow-xl transition ease-in-out duration-300 hover:-translate-y-1 hover:scale-110 hover:shadow-2xl hover:opacity-95"
        :ui="{
        ...
        <div class="flex flex-col justify-center items-center">
            <span
                ...
                :style="
                    Number(
                        Number(budget.value) - Number(budget.expenses || 0)
                    ) < 0
                        ? 'color: rgb(227, 0, 0)'
                        : ''
                ">
