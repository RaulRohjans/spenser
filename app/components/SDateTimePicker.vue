...
<style scoped lang="scss">
    .dp__theme_dark {
        ...
        --dp-primary-color: #efb100;
        --dp-primary-disabled-color: #61a8ea;
        --dp-primary-text-color: #fff;
        --dp-secondary-color: #a9a9a9;
        --dp-border-color: #364153;
        --dp-menu-border-color: #364153;
        --dp-border-color-hover: #364153;
        --dp-border-color-focus: #efb100;
    ...
    .dp__theme_light {
        ...
        --dp-border-color: #d1d5dc !important;
        --dp-menu-border-color: #d1d5dc;
        --dp-border-color-hover: #d1d5dc !important;
        --dp-border-color-focus: #efb100;
