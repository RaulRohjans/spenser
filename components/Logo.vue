...
<template>
    ...
    <div :class="props.class">
        <img src="/icons/logo.svg" alt="Spenser Logo" class="block dark:hidden" :style="`width: ${props.width}; height: ${props.height}`"/>
        <img src="/icons/logo-light.svg" alt="Spenser Logo" class="hidden dark:block" :style="`width: ${props.width}; height: ${props.height}`" />
    </div>
</template>